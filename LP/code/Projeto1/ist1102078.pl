...
actualiza_vizinhas_entrada(Pos1, Pos2, Posicoes, [IlhaAlvo, Vizinhas, Pontes], Nova_Entrada) :-
    findall(X, (member(X, Vizinhas), caminho_livre(Pos1, Pos2, Posicoes, IlhaAlvo, X)), ListaVizinhas),
    Nova_Entrada = [IlhaAlvo, ListaVizinhas, Pontes].
...
actualiza_vizinhas_apos_pontes([], _, _, NovoEstado, NovoEstado).

actualiza_vizinhas_apos_pontes([P_Estado | R_Estado], Pos1, Pos2, NovoEstado, AcumulaEstados) :-
    posicoes_entre(Pos1, Pos2, Posicoes),
    actualiza_vizinhas_entrada(Pos1, Pos2, Posicoes, P_Estado, NovoEstado),
    append(NovoEstado, AcumulaEstados),
    actualiza_vizinhas_apos_pontes(R_Estado, Pos1, Pos2, NovoEstado, AcumulaEstados).
