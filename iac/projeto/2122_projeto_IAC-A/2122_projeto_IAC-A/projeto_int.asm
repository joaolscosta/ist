...
ALTURA		EQU	4			; largura do boneco
COR_PIXEL		EQU	0D58FH		; cor do pixel: vermelho em ARGB (opaco e vermelho no máximo, verde e azul a 0)
...
DEF_BONECO:					; tabela que define o boneco (cor, largura, pixels)
	...
	WORD		COR_PIXEL, 0, 0, 0, COR_PIXEL		; # # #   as cores podem ser diferentes
