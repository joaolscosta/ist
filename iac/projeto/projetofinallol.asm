...
COR_METEORO_MIN			EQU 0B444H
COR_METEORO2			EQU 0B444H  	; cor do pixel do meteoro: verde em ARGB  	; cor do pixel do meteoro: verde em ARGB
COR_NAVE1				EQU 0FF00H
COR_NAVE2				EQU 0FF10H
COR_NAVE3				EQU 0FF01H
...
energia_inicial_2: 	WORD 69H	; variavel que guarda o valor da energia inicial do rover
...
seleciona_nave:			WORD 0

nave_colidida:			WORD 0
