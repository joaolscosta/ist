...
; *
; * Nota:  Igual a lab5-registos.asm mas usando uma única rotina para escrever nos 
...
;	CALL hexa_high			; escreve 3 no display high
	...
	MOV  R1, 37H
	CALL hexa_display		; substitui os dois CALLs anteriores (agora em comentário)
...
; Argumentos: R1 - número (entre 0 e FFs) a escrever no displays hexadecimais
;
; **********************************************************************
hexa_display:
...
; Argumentos: R0 - número (entre 0 e FH) a escrever no display hexadecimal
;
; **********************************************************************
hexa_low:
