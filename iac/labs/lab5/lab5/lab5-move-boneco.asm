; *********************************************************************************
; * IST-UL
; * Modulo:    lab5-move-boneco.asm
; * Descrição: Este programa ilustra o movimento de um boneco do ecrã, usando rotinas,
; *			com um atraso para limitar a velocidade de movimentação.
; *********************************************************************************
