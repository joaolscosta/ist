; *********************************************************************************
; * IST-UL
; * Modulo:    lab7-cooperativas-teclado-bloqueante.asm
; * Descrição: Este programa ilustra o funcionamento de várias rotinas cooperativas,
; *			com o erro de que uma das rotinas é bloqueante.
; *			Igual ao lab7-cooperativas-barras-displays-OK.asm, com a adição de uma rotina
; *			TECLADO que tem um ciclo infinito e só retorna quando se carrega
; *			numa tecla da 4ª linha do teclado.
; *
; *********************************************************************************
...
DELAY			EQU  100H		; valor usado para implementar um atraso temporal    
...
; **********************************************************************
; TECLADO - Rotina (pouco) cooperativa que deteta quando se carrega numa tecla na 4ª linha
;		  do teclado. É bloqueante e só retorna quando uma tecla é carregada.
; **********************************************************************
teclado:
	PUSH R0
	PUSH R1
...
espera_tecla:                 ; neste ciclo espera-se até uma tecla ser premida
	...
	JZ   espera_tecla        ; se nenhuma tecla premida, repete
						; ciclo bloqueante!!! (até haver uma tecla carregada)
...
ha_tecla:                     ; neste ciclo espera-se até NENHUMA tecla estar premida
	...
	AND  R0, R5			; elimina bits para além dos bits 0-3
     ...
     JNZ  ha_tecla            ; se ainda houver uma tecla premida, espera até não haver
						; ciclo bloqueante!!! (enquanto houver uma tecla carregada)
...
; **********************************************************************
; ANIMA_DISPLAYS - Rotina cooperativa que avança o valor dos displays de uma unidade
; **********************************************************************
anima_displays:
	PUSH R0
	PUSH R1
	...
	MOV  R2, [contador]		; obtém valor do contador, cujo valor vai ser mostrado nos displays
	...
	MOV  [contador], R2		; atualiza valor do contador
sai_anima_displays:
	POP  R2
	POP  R1
	POP  R0
...
; **********************************************************************
; ANIMA_BARRA - Rotina cooperativa que desenha e faz descer uma barra de 8 pixels no ecrã,
