; *********************************************************************************
; * IST-UL
; * Modulo:    lab7-cooperativas-barras-displays-OK.asm
...
; *			O ciclo de atraso é externo à rotina que faz contar os displays, pelo que
; *			o atraso não tem impacto na temporização das interrupções.
; *
; *********************************************************************************
