; *********************************************************************************
; * IST-UL
; * Modulo:    lab7-cooperativas-barras-displays.asm
; * Descrição: Este programa ilustra o funcionamento de várias rotinas cooperativas.
; *			Uma das rotinas faz contar os displays, com temporização feita
; *			por um ciclo de atraso.
; *			As outras rotinas cooperativas animam as barras que caem no ecrã, com
; *			o movimento das barras sincronizadas com interrupções.
; *			Se o ciclo de atraso for grande, pode estragar as temporizações
; *			dos relógios ligados às interrupções.
; *
; *********************************************************************************
...
ciclo:
	...
	; Estes 4 CALLs podiam ser feitos num ciclo, incrementando ou decrementando o R3, mas assim é mais explícito
