; *********************************************************************************
; * IST-UL
; * Modulo:    lab7-cooperativas-teclado-OK.asm
; * Descrição: Este programa ilustra o funcionamento de várias rotinas cooperativas,
; *			em que nenhuma das rotinas é bloqueante.
; *			Igual ao lab7-cooperativas-teclado-bloqueante.asm, mas em que a rotina
; *			TECLADO retorna sempre, haja ou não tecla carregada (na 4ª linha do teclado).
; *
; *********************************************************************************
...
DELAY			EQU  40H		; valor usado para implementar um atraso temporal    
...
; **********************************************************************
; ANIMA_DISPLAYS - Rotina cooperativa que aumenta ou diminui o valor dos displays de uma unidade,
;			    consoante não haja, ou haja, respetivamente, uma tecla premida na 4ª linha do teclado
; **********************************************************************
anima_displays:
	PUSH R0
	PUSH R1
	...
	MOV  R1, [coluna_carregada]	; obtém em R1 a informação sobre se há ou não tecla premida
